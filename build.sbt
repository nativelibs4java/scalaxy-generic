...
homepage := Some(url("https://github.com/nativelibs4java/scalaxy-generic"))

pomExtra := (
  <scm>
    <url>git@github.com:nativelibs4java/scalaxy-generic.git</url>
    <connection>scm:git:git@github.com:nativelibs4java/scalaxy-generic.git</connection>
  </scm>
  <developers>
    <developer>
      <id>ochafik</id>
